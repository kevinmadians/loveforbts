...
export function Footer() {
  ...
  return (
    <footer className="bg-[#FFDE00] border-t-2 border-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex space-x-3">
              ...
              <SocialLink href="https://www.youtube.com/@BTS" icon={
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M9.545 15.568V8.432L15.818 12l-6.273 3.568z" fill="#FFDE00" />
                </svg>
              } label="YouTube" />
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold mb-4 black-han-sans">Quick Links</h3>
...
function FooterLink({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) {
  return (
    <li>
      <Link href={href} className="flex items-center text-black hover:text-purple-900 transition-colors">
