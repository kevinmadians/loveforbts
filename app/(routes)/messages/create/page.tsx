    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border-2 border-black p-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
          ...
          <li>Your name must be between 2-50 characters long.</li>
          <li>Your message must be between 5-500 characters long.</li>
          <li>URLs and links are not allowed in messages.</li>
        </ul>
      </div>
    </div>
  )
